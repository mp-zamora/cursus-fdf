...
/*   Updated: 2024/10/08 19:14:37 by mpenas-z         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
uint32_t	get_color(float x, float y, t_coords min, t_coords max)
{
	...
	color_p[3] = (color_a[3] + (color_b[3] - color_a[3]) * percent);
	return (color_p[3] << 24 | color_p[0] << 16 | color_p[1] << 8 | color_p[2]);
}
